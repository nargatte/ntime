...
namespace BaseCoreTests.DataBase
{
    ...
    public class CompetitionRepositoryTests : RepositoryTestsBase<Competition>
    {
        ...
        {
            new Competition("Zawody 1", new DateTime(2017, 11, 6), "Opis zawodów 1" , "Zawody1.pl", "Organizator1", "Miasto zawodów", CompetitionTypeEnum.Fastest),
            new Competition("Zawody 2", new DateTime(2017, 11, 6), null, null, null, null,
                CompetitionTypeEnum.MostLaps),
            new Competition("Zawody 3", new DateTime(2017, 11, 6), "Opis zawodów 3", null, null, null,
                CompetitionTypeEnum.Fastest),
